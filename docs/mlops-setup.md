...
git add README.md docs .gitignore cicd_and_project/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://dbc-c39b2ad9-5956.cloud.databricks.com#setting/accounts) and
...
If you want to use different catalog names, please update the target names declared in the[cicd_and_project/databricks.yml](../cicd_and_project/databricks.yml) file.
...
Follow the instructions in [cicd_and_project/resources/README.md](../cicd_and_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../cicd_and_project/resources/README.md)  to propose, test, and deploy
