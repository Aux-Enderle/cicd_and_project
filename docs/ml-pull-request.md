...
Opening a pull request will trigger a[workflow](../.github/workflows/cicd_and_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-c39b2ad9-5956.cloud.databricks.com/explore/data/models/staging/cicd_and_project/cicd_and_project-model)
* [Prod model in UC](https://your-prod-workspace.cloud.databricks.com/explore/data/models/prod/cicd_and_project/cicd_and_project-model)
. 
